...
local RayfieldFolder = "Slayer Hub"
		...
		if useStudio then
			...
			task.spawn(function()
				...
				if success and reporter then
					pcall(function()
						reporter.report("Slayer Hub", Release, InterfaceBuild)
					end)
				else
...
repeat
	...
	toDestroy, Rayfield = Rayfield, useStudio and script.Parent:FindFirstChild('Slayer Hub') or game:GetObjects("rbxassetid://10804731440")[1]
